...
The Vietoris-Rips complex of a set of randomly-wandering points, in your browser.
Written in `clojurescript`, based on [re-frame](https://github.com/day8/re-frame).
...
* [`src/cljs/rips_web/`](src/cljs/rips_web/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/rips_web/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `rips-web` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/rips_web/config.cljs) defaults to `true` in
...
```clj
(ns rips-web.example
  (:require [rips-web.config :as config])
